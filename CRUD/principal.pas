...
begin
  ...
  begin
    MessageDlg('O Campo não pode ser vazio para realizar essa ação, verifique!', mtInformation, [mbOk], 0);
    Exit;
  end;
  Alterar;
end;
...
begin
  ...
  begin
    MessageDlg('Campo não pode ser vazio para que seja iniciado a busca, verifique.', mtInformation, [mbOK], 0);
    Exit;
  end;
...
begin
  ...
  begin
    MessageDlg('Campo não pode ser vazio, verifique e tente novamente.', mtInformation, [mbOk], 0);
    Exit;
  end;
  Inserir(vCpf);
end;
